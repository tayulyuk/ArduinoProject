...
const char* outTopic = "sftTest/result"; // 밖으로 내보내는 토픽.
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientName)) {
      ...
      // ... and resubscribe    
     client.subscribe("sftTest/button1");
     client.subscribe("sftTest/button2");
     client.subscribe("sftTest/button3");
     client.subscribe("sftTest/button4");
     client.subscribe("sftTest/buttonPower");
